...
* [Contact Form 7](https://it.wordpress.org/plugins/contact-form-7/ "Contact Form 7"): CSS rules perfectly define appearence of forms created with Contact Form 7. In CF7 editor just wrap your form into a DIV with class "form-hold";
* [Flamingo](https://wordpress.org/plugins/flamingo/ "Flamingo") Flamingo is a message storage plugin originally created for Contact Form 7;
