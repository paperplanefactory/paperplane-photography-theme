    ...
    while (have_rows('slides_manager_repeater')):
      ...
      <div class="scroll-image lined">
        <?php if ($slides_manager_repeater_content_type === 'picture'): ?>
          ...
          ?>
          <div class="wrapper-padded">
            <div class="wrapper-padded-more-840 aligncenter">
              ...
              <?php if ($abilitare_la_vendita === 'si'): ?>
                <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank"
                  class="delight-area pay-picture-list">
                  ...
                  <button type="submit" title="Buy this picture"
                    aria-label="<?php _e('Buy this picture', 'paperplane-photography-theme'); ?>">Buy this picture</button>
                </form>
              <?php endif; ?>
            </div>
          </div>
