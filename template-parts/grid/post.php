<div class="flex-hold-child grid-item-infinite <?php echo $zoomed_class; ?>">
	<a href="<?php the_permalink(); ?>" class="data-swup-preload"
		title="<?php _e( 'View project:', 'paperplane-photography-theme' ); ?> <?php the_title(); ?>"
		aria-label="<?php _e( 'View project:', 'paperplane-photography-theme' ); ?> <?php the_title(); ?>">
	...
	<div class="flex-hold-title">
		<a href="<?php the_permalink(); ?>" class="absl data-swup-preload"
			title="<?php _e( 'View project:', 'paperplane-photography-theme' ); ?> <?php the_title(); ?>"
		...
		<div>
			...
			if ( $show_cats === 'yes' ) {
				...
				if ( function_exists( 'call_categories' ) ) {
					call_categories();
				}
				echo '</div>';
			}
