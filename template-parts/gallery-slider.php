    ...
    <div class="wrapper-padded">
      <div class="wrapper-padded-more-650">
        <div class="gallery-slider-nav gallery-slider-nav-js">
          <?php
          $slide_counter = 0;
          if ( have_rows( 'slides_manager_repeater' ) ) : while ( have_rows( 'slides_manager_repeater' ) ) : the_row();
          ...
          <div class="slide-thumb" data-slide="<?php echo $slide_counter; ?>">
            <?php if ( $slides_manager_repeater_content_type === 'picture' ) {
              ...
              if ( get_sub_field('slides_manager_repeater_embed_video_cover') ) {
                $image_data = array(
                    'image_type' => 'acf_sub_field', // options: post_thumbnail, acf_field, acf_sub_field
                    'image_value' => 'slides_manager_repeater_embed_video_cover', // se utilizzi un custom field indica qui il nome del campo
                    'size_fallback' => 'thumb_gallery'
                );
                $image_sizes = array( // qui sono definiti i ritagli o dimensioni. Devono corrispondere per numero a quanto dedinfito nella funzione nei parametri data-srcset o srcset
                  'desktop_retina' => 'thumb_gallery',
...
<div class="gallery-slider gallery-slider-js" data-slick='{"autoplaySpeed": <?php the_field( 'set_image_duration', 'options' ); ?>}'>
  <?php
  if ( have_rows( 'slides_manager_repeater' ) ) : while ( have_rows( 'slides_manager_repeater' ) ) : the_row();
  $slides_manager_repeater_content_type = get_sub_field( 'slides_manager_repeater_content_type' );
  ...
  ?>
  <div class="slide-picture-contaniner" data-content="<?php echo $slide_type; ?>" data-sale="<?php echo $buy_button_status; ?>">
